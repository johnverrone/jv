...
-- Ported verbatim from the command-center Worker so this app's D1 is schema-compatible
-- whether we point it at a fresh database or the existing command-center one.
